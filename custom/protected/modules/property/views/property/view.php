...
$modelType = json_encode("Property");
...
<div class="page-title icon property">
	...
	<?php
    if(Yii::app()->user->checkAccess('PropertyUpdate',$authParams)){
...
// $this->renderPartial('application.components.views.@DETAILVIEW',array('model'=>$model,'form'=>$form,'modelName'=>'property'));
...
$this->widget('InlineEmailForm',
	array(
		...
		'insertableAttributes' => 
            array(Yii::t('property','{module} Attributes', array('{module}'=>Modules::displayName(false)))=>$model->getEmailInsertableAttrs ()),
		'startHidden'=>true,
	)
);
