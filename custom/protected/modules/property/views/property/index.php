...
");
$dataProvider=null;
if ($this->route == 'property/property/index') {
...
$this->widget('X2GridView', array(
	...
	'template'=>
        ...
        '<div id="x2-gridview-page-title" '.
         'class="page-title icon property x2-gridview-fixed-title">'.
