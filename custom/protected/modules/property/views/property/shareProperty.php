...
$this->actionMenu = $this->formatMenu(array(
    array(
        'label'=>Yii::t('property','All {module}', array('{module}'=>Modules::displayName())),
        'url'=>array('index')),
    array(
        'label'=>Yii::t('property','Create {module}', array('{module}'=>Modules::displayName(false))),
        'url'=>array('create')),
	array('label'=>Yii::t('property','View'), 'url'=>array('view','id'=>$model->id)),
    array(
        'label'=>Yii::t('property','Edit {module}', array('{module}'=>Modules::displayName(false))),
        'url'=>array('update', 'id'=>$model->id)),
	array('label'=>Yii::t('property','Share {module}', array('{module}'=>Modules::displayName(false)))),
    array(
        'label'=>Yii::t('property','Delete {module}', array('{module}'=>Modules::displayName(false))),
        'url'=>'#',
        'linkOptions'=>array(
...
?>
<div class="page-title icon property">
...
?>
<div class="page-title icon property">
	<h2><span class="no-bold"><?php echo Yii::t('property','{module}:', array('{module}'=>Modules::displayName(false))); ?></span> <?php echo CHtml::encode($model->name); ?></h2>
</div>
<?php
$this->widget ('DetailView', array(
    'model' => $model
));
// $this->renderPartial('application.components.views.@DETAILVIEW',array('model'=>$model,'modelName'=>'property','form'=>$form)); 
$this->endWidget(); ?>
