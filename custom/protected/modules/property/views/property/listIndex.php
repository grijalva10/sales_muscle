...
$heading = Yii::t('property','{module} Lists', array('{module}'=>Modules::displayName(false))); 
...
$this->widget('X2GridViewGeneric', array(
	...
	'template'=> '<div class="page-title icon property"><h2>'.$heading.'</h2>{buttons}{filterHint}{summary}</div>{items}{pager}',
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			'value'=>'CHtml::link($data["name"],Yii::app()->createUrl (\'/property/list\', array (\'id\' => $data[\'id\'])))',
		),
		array(
			'name'=>'type',
			'header'=>$attributeLabels['type'],
			'type'=>'raw',
			'value'=>'$data["type"]=="static"? Yii::t("property","Static") : Yii::t("property","Dynamic")',
		),
		array(
			'name'=>'assignedTo',
        ...
        array (
            ...
            'updateButtonUrl' => 
                "Yii::app()->createUrl ('/property/updateList', array ('id' => \$data['id']))",
            'cssClassExpression' =>
                "!is_numeric (\$data['id']) ? 'hide-edit-delete-buttons' : ''",
            'viewButtonUrl' =>
                "Yii::app()->createUrl ('/property/list', array ('id' => \$data['id']))",
            'deleteButtonUrl' => 
                "Yii::app()->createUrl ('/property/deleteList', array ('id' => \$data['id']))",
        ),
	),
)); ?>
<div class="form">
<?php echo CHtml::link('<span>'.Yii::t('app','New List').'</span>',array('/property/property/createList'),array('class'=>'x2-button')); ?>
</div>
