                ...
                <div class="row">
                    ...
                    if ($loginLogo) {
                        echo CHtml::link(CHtml::image(
                                ...
                                )), 'https://www.#.com/', array('class' => 'login-logo-link'));
                    } else {
                    ...
                    <div class="row login-links">
                        <div class="cell x2touch-cell">
                            <?php
                            echo CHtml::link('<img src="' . Yii::app()->theme->baseUrl . '/images/mobile.png" id="mobile-icon" /><span>' . Yii::t('app', 'Mobile View') . '</span>', Yii::app()->getBaseUrl() . '/index.php/mobile/login', array('class' => 'x2touch-link alt-sign-in-link text-link'));
                            ?>
                        </div>
                        <?php
                    ...
                    <div id="login-version">
                        ...
                        <span> <a href="https://www.grijalvahershiser.com">JMG CRM</a>, v. <?php echo Yii::app()->params->version; ?></span>
