...
<div id="footer">
    ...
    ?><!-- -->
	<b>JMG <?php echo Yii::app()->params->version; ?>
	</b> |
	<a href="http://www.grijalvahershiser.com/">JMG</a> |
	<?php echo CHtml::link('Mobile UI',array('/x2touch')); ?>  |
        <?php echo CHtml::link(Yii::t('app','About'),array('/site/page','view'=>'about')); ?>
    <br>
    JMG Industrial Client Management System <?php echo date('Y'); ?>
